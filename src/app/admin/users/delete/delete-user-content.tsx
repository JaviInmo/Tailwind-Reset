...
import { handleDeleteUserAction } from "./delete.action"
...
// Client component with proper type definition
export function DeleteUserContent({ id, userName }: DeleteUserContentProps) {
