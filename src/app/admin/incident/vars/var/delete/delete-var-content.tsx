...
import { handleDeleteVariableAction } from "./delete.action"

interface DeleteVarContentProps {
  id: number
  varName?: string
}

export function DeleteVarContent({ id, varName }: DeleteVarContentProps) {
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          <div className="mb-6 text-center">
            <p className="text-black">
              ¿Estás seguro de que deseas eliminar la variable {varName ? <strong>"{varName}"</strong> : null}?
            </p>
          </div>
